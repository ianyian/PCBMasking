...
- **Action log (right edge, transparent overlay)** — a timestamped
  before/after history of every action (step started / finished, counts,
  durations, verdicts). New entries appear at the bottom in solid color and
